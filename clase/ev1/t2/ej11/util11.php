...
function pintarCheckbox($nom, $arrayValueLabel, $seleccionados){
    ...
    foreach ($arrayValueLabel as $value => $label){
        //aqui se usa in_array porque los checkbox pueden seleccionar varios entionces tenemos que buscar dentro d eun array y comparar si está ahí
        ...
        //Aquñi va todo el código html para puntarlo con las opciones que le pasemos
    }
