...
class Empleado_model extends CI_Model
{
    ...
    public function crearEmpleado($nombre,$apellido,$idDepartamento,$pwd)
    {
        $departamento = R::load('departamento',$idDepartamento);
        $empleado = R::findOne('user','nombre=? and apellido=?',[$nombre,$apellido]);
        
        $ok = ($empleado==null&&$nombre != null && $apellido != null&& $departamento != null &&  $pwd != null);
        if ($ok) {
            ...
            $e = ($nombre == null||$apellido == null || pwd == $pwd? new Exception("Introduzca datos") : new Exception("Alumno duplicado"));
            throw $e;
        }
    }
